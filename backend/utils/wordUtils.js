...
async function crearDocDesdeJSON(json, outputPath) {
  ...
  if (educacion.length > 0) {
    seccion.push(
      new Paragraph({ children: [new TextRun({ text: "Educación", bold: true, size: 28 })], spacing: { before: 300, after: 200 } })
    );
  ...
  if (certs.length > 0) {
    seccion.push(
      new Paragraph({ children: [new TextRun({ text: "Certificaciones", bold: true, size: 28 })], spacing: { before: 300, after: 200 } })
    );
  ...
  if (experiencia.length > 0) {
    seccion.push(
      new Paragraph({ children: [new TextRun({ text: "Experiencia Laboral", bold: true, size: 28 })], spacing: { before: 300, after: 200 } })
    );
  ...
  if (idiomas.length > 0) {
    seccion.push(
      new Paragraph({ children: [new TextRun({ text: "Idiomas", bold: true, size: 28 })], spacing: { before: 300, after: 200 } })
    );
  ...
  if (conocimientos.length > 0) {
    seccion.push(
      new Paragraph({ children: [new TextRun({ text: "Conocimientos Informáticos", bold: true, size: 28 })], spacing: { before: 300, after: 200 } })
    );
